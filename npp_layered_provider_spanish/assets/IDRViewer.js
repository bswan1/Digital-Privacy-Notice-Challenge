...
function addToolBarPDFLink() {
    
    var imgNode = new Image();
    imgNode.src = "assets/downloadPDF.png";

    var linkNode = document.createElement('a');
    linkNode.setAttribute("download", "downloadedPDF.pdf");
    linkNode.href = "downloadPDF.pdf";
    linkNode.className = "customNavPDFLink";
    linkNode.appendChild(imgNode);
    linkNode.setAttribute("target","_blank");
    d('btnZoomIn').parentNode.insertBefore(linkNode, d('btnZoomIn').nextSibling);
}
